...
// node_modules/@csvbox/react/dist/index.modern.js
...
var version = "1.1.14";
var CSVBoxButton = function(_Component) {
  _inheritsLoose(CSVBoxButton2, _Component);
  function CSVBoxButton2(props) {
    var _this;
    _this = _Component.call(this, props) || this;
    _this.holder = import_react.default.createRef();
  ...
  var _proto = CSVBoxButton2.prototype;
  ...
  _proto.render = function render() {
    ...
    if (this.props.render) {
      return import_react.default.createElement("div", null, this.props.render(this.openModal, this.state.isLoading), import_react.default.createElement("div", {
        ref: this.holder,
        style: holderStyle
      }));
    } else {
      return import_react.default.createElement("div", null, import_react.default.createElement("button", {
        disabled: this.state.isLoading,
        onClick: this.openModal,
        "data-csvbox-initator": true,
        "data-csvbox-token": this.uuid
      }, this.props.children), import_react.default.createElement("div", {
        ref: this.holder,
        style: holderStyle
      }));
    }
  };
  return CSVBoxButton2;
}(import_react.Component);
var index_modern_default = CSVBoxButton;
export {
  CSVBoxButton,
  index_modern_default as default
};
//# sourceMappingURL=@csvbox_react.js.map
