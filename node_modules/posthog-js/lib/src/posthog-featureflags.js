...
var parseFlagsResponse = function (response, persistence, currentFlags, currentFlagPayloads, currentFlagDetails) {
    ...
    // using the v1 api
    if ((0, type_utils_1.isArray)(featureFlags)) {
    ...
    PostHogFeatureFlags.prototype.getFlagsWithDetails = function () {
        ...
        try {
            for (var overriddenKeys_1 = __values(overriddenKeys), overriddenKeys_1_1 = overriddenKeys_1.next(); !overriddenKeys_1_1.done; overriddenKeys_1_1 = overriddenKeys_1.next()) {
                ...
                var finalEnabled = (0, type_utils_1.isUndefined)(overrideFlagValue)
                    ? ((_b = originalDetail === null || originalDetail === void 0 ? void 0 : originalDetail.enabled) !== null && _b !== void 0 ? _b : false)
                    : !!overrideFlagValue;
                var overrideVariant = (0, type_utils_1.isUndefined)(overrideFlagValue)
    ...
    PostHogFeatureFlags.prototype.getFeatureFlag = function (key, options) {
        ...
        if (options.send_event || !('send_event' in options)) {
            if (!(key in flagCallReported) || !flagCallReported[key].includes(flagReportValue)) {
                if ((0, type_utils_1.isArray)(flagCallReported[key])) {
                ...
                if (!(0, type_utils_1.isUndefined)((_g = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _g === void 0 ? void 0 : _g.version)) {
                ...
                if (!(0, type_utils_1.isUndefined)(flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.original_variant) || !(0, type_utils_1.isUndefined)(flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.original_enabled)) {
                    properties.$feature_flag_original_response = !(0, type_utils_1.isUndefined)(flagDetails.original_variant)
        ...
        if (overrideOptions &&
            ...
            if ('flags' in options) {
                if (options.flags === false) {
                    ...
                    if ((0, type_utils_1.isArray)(options.flags)) {
                        var flagsObj = {};
        ...
        if (!existing_early_access_features || force_reload) {
            this._instance._send_request({
                ...
                callback: function (response) {
                    ...
                    (_b = _this._instance.persistence) === null || _b === void 0 ? void 0 : _b.register((_a = {}, _a[constants_1.PERSISTENCE_EARLY_ACCESS_FEATURES] = earlyAccessFeatures, _a));
