...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        this.persistence = new posthog_persistence_1.PostHogPersistence(this.config);
        this.sessionPersistence =
            this.config.persistence === 'sessionStorage' || this.config.persistence === 'memory'
                ? this.persistence
                : new posthog_persistence_1.PostHogPersistence(__assign(__assign({}, this.config), { persistence: 'sessionStorage' }));
    ...
    PostHog.prototype.captureException = function (error, additionalProperties) {
        ...
        this.exceptions.sendExceptionEvent(__assign(__assign({}, (0, error_conversion_1.errorToProperties)((0, type_utils_1.isError)(error) ? { error: error, event: error.message } : { event: error }, 
